...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['submit_Btn'])) {
        ...
        $venue_description= mysqli_real_escape_string($conn, $_POST['venue_description']);
            ...
            // Insert the new event without specifying venue_id column
            ...
            if ($stmt) {
                ...
                if ($result) {
                    // Get the auto-incremented venue_id
                                            ...
                                            <div class="w-full">
                                                <div class="w-full flex items-center justify-between">
                                                    ...
                                                    <div class="flex items-center space-x-4">
                                                        <h1 class="text-md text-gray-700 font-bold"><span id="card-count">12</span> Venues</h1>
                                                        <!--Sort button-->                                            
                                                    ...
                                                    <?php
                                                        ...
                                                        if (mysqli_num_rows($result) > 0) {
                                                            ...
                                                            while ($row = mysqli_fetch_assoc($result)) {
                                                                ...
                                                                echo '<div id="event-' . $venue_id . '" class="max-w-sm bg-white border h-56 p-3 border-gray-200 rounded-xl shadow dark:bg-gray-800 dark:border-gray-700">';
                                                                ...
                                                                echo '</button>';
                                                                // Dropdown menu
                                                                echo '<div id="dropdown-' . $venue_id . '" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-md border-2 border-gray-200 w-32 dark:bg-gray-700">';
                                                                ...
                                                                echo '<li>';
                                                                echo '<a href="javascript:void(0);" onclick="deleteEvent(' . $venue_id . ')" class="block px-4 rounded-md py-2 text-sm font-medium text-gray-500 hover:text-red-500  hover:bg-red-200 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"><i class="fa-solid fa-trash-can mr-2"></i>Delete</a>';
                                                                echo '</li>';
                                                                echo '</ul>';
                                                                echo '</div>';
                                                                echo '</div>';
                                                                ...
                                                                echo '<span class="text-sm text-gray-500 dark:text-gray-400">' . $venue_description . '</span>';
                                                                echo '<span class="text-sm text-gray-500"></span>';
                                                                echo '<span class="text-sm text-gray-500 dark:text-gray-400">' . $generated_id . '</span>';
                                                                echo '</div>';
                                                                echo '</div>';
                                                            ...
                                                            while ($row = mysqli_fetch_assoc($result)) {
                                                                ...
                                                                echo '<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">';
                                                                    ...
                                                                    echo '<td class="px-6 py-4">';
                                                                        ...
                                                                        echo '<button onclick="deleteEvent(' . $venue_id . ')" class="font-medium text-red-600 dark:text-red-500 hover:underline ml-2">Delete</button>';
                                                                    echo '</td>';
                                                                echo '</tr>';
                                                            }
                                                        } else {
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                openModalButtons.forEach((button) => {
                    button.addEventListener("click", function () {
                        ...
                        const venueDescription = card.dataset.venueDescription;
                        const generatedId = card.dataset.generatedId;

                        // Populate the input fields with data from the clicked card
