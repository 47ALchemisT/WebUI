        ...
        <main class="px-4 py-0 sm:ml-80" style="margin-left: 320px;">
            <div class="container">
                <div class="flex w-full gap-4 relative">
                    ...
                    <div class="flex-1">
                        <div class="px-4 pt-4 text-3xl font-bold text-gray-800">User</div>
                        <p class="px-4 text-sm text-gray-500 mb-4 font-semibold">List of user accounts</p>
                        <div class="overflow-y-auto">
                            ...
                            <div class="bg-white shadow-lg mb-5 mt-1 p-4 rounded-lg w-full">
                                ...
                                <div id="venueContainer" class="grid grid-cols-4 gap-5">
                                    <div class="max-w-sm bg-white h-full border-2 shadow-md p-3 border-gray-200 rounded-lg hover:shadow-blue-700 dark:bg-gray-800 dark:border-gray-700 flex flex-col justify-center items-center hover:border-blue-500">
                                    ...
                                    <div id="<?= $ID ?>" class="card z-1 max-w-sm relative bg-white border-2 shadow-md hover:shadow-blue-600 p-4 border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 hover:border-blue-500" data-id="<?= $ID ?>" data-firstname="<?= $firstname ?>" data-lastname="<?= $lastname ?>" data-username="<?= $username ?>" data-email="<?= $email ?>" data-job="<?= $job ?>" data-password="<?= $password ?>">
